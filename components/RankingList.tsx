    ...
    <div className="grid grid-cols-2 gap-2.5 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5">
      {entries.map((entry) => (
        <Link
          ...
          className="group flex items-center gap-3 rounded-xl border border-violet-100 bg-white/85 px-4 py-3 transition hover:-translate-y-0.5 hover:border-indigo-400 hover:shadow-md"
        >
